...
<div class="content-wrapper">
	...
	<!-- SweetAlert -->
	<div class="flash-data-mobil" data-flashdata="<?= $this->session->flashdata('message_ubah_mobil'); ?>"></div>
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-default shadow-sm" style="border-radius:10px;">
						<!-- form start -->
						<?= form_open_multipart('pegawai/datamobil/ubah/'.$getmobil['id_mobil']);?>
							...
							<div class="card-body">
									...
									<div class="col-sm">
										<select class="form-control select2bs4 <?= form_error('id_seri') ? 'is-invalid' : ''; ?>" name="id_seri" style="width: 100%;">
											...
											<?php foreach ($getseri as $s ) :?>
												<?php if( $getmobil['id_seri'] == $s['id_seri'] ) : ?>
									...
									<div class="col-sm">
										<select class="form-control select2bs4 <?= form_error('id_jenis') ? 'is-invalid' : ''; ?>" name="id_jenis" style="width: 100%;">
											...
											<?php foreach ($getjenis as $s ) :?>
												<?php if( $getmobil['id_jenis'] == $s['id_jenis'] ) : ?>
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										...
										id="warna" name="warna" placeholder="Warna Mobil" value="<?= $getmobil['warna']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										...
										id="tahun" name="tahun" placeholder="Tahun Mobil" value="<?= $getmobil['tahun']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										...
										id="plat_nomor" name="plat_nomor" placeholder="Plat Nomor" value="<?= $getmobil['plat_nomor']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										...
										id="nomor_rangka" name="nomor_rangka" placeholder="Nomor Rangka" value="<?= $getmobil['nomor_rangka']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										...
										id="nomor_mesin" name="nomor_mesin" placeholder="Nomor Mesin" value="<?= $getmobil['nomor_mesin']; ?>">
								...
								<div class="form-group row">
									...
									<div class="col-sm">
										<div class="input-group mb-3">
											...
											id="harga" name="harga" placeholder="Harga Mobil" value="<?= $getmobil['harga']; ?>">
